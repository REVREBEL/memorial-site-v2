...
export function CardSizeVariant({
  ...
  return (
    ...
    >
      ...
      >
        <_Builtin.Block
          className={_utils.cx(_styles, "div-block-47", _activeStyleVariant)}
          tag="div"
        >
          <_Builtin.Block
            className={_utils.cx(
      ...
      <_Builtin.Block
        className={_utils.cx(_styles, "color-card", _activeStyleVariant)}
        tag="div"
      />
      {imageVisibility ? (
        <_Builtin.Block
