...
export function Tag2(
    ...
    return tagField1FormInputVisibility ? <_Component className="form_field-wrapper" tag="div" id={tagField1FormInputId2}><_Builtin.FormBlockLabel className="input_label" htmlFor="Phone">{"Optional HasHtag"}</_Builtin.FormBlockLabel><_Builtin.Block className="form-field_icon-component" tag="div">{fromInputVisibility ? <_Builtin.HtmlEmbed
                ...
                required={false}
                autoFocus={false}
                id="Tag-3" /></_Builtin.Block></_Component> : null;
}