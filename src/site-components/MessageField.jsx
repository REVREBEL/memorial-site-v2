...
export function MessageField(
    ...
    return shareAMemoryFormInputVisibility ? <_Component className="form_field-wrapper" tag="div" id={shareAMemoryFormInputId}><_Builtin.FormBlockLabel className="form_label" htmlFor="Phone"><_Builtin.Strong className="input_label">{"Your Message *"}</_Builtin.Strong></_Builtin.FormBlockLabel><_Builtin.Block className="text-area_component" tag="div"><_Builtin.HtmlEmbed
                className="hide"
                ...
                id="Message" /><_Builtin.FormBlockLabel
                className="form_label"
                htmlFor="Phone"
                {...shareAMemoryFormInputRuntimeProps}>{shareAMemoryFormInputCharactersSlot ?? shareAMemoryFormInputLabel}</_Builtin.FormBlockLabel></_Builtin.Block></_Component> : null;
}