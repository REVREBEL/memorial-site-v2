...
export function ButtonOutlineWithIcon(
    ...
    return visibility ? <_Component
        ...
        tag="div"
        id={buttonId}><_Builtin.Block className={`tag is-secondary ${_activeStyleVariant}`} tag="div"><ComponentIcon
                ...
                variant="Pie" /><_Builtin.Link
                className={`button_label is-secondary is-icon ${_activeStyleVariant}`}
                button={true}
                block=""
                options={buttonLink}>{buttonText}</_Builtin.Link></_Builtin.Block></_Component> : null;
}